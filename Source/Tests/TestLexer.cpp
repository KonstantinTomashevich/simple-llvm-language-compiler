...
int main (int argumentsCount, char* arguments [])
{
    std::string code =
            ...
            "extern inbuilt_func (arg1, arg2)\n" // 7 tokens, TOKEN_EXTERN_COMMAND, TOKEN_IDENTIFIER, TOKEN_OPERATOR, TOKEN_IDENTIFIER, TOKEN_OPERATOR, TOKEN_IDENTIFIER, TOKEN_OPERATOR
            "# Multi\n" // 0 tokens
            "# line\n" // 0 tokens
            "# comment\n" // 0 tokens
    ...
    if (tokens.size () != 18)
    {
        std::cout << "Error in tokens count: expected 18, but got " << tokens.size () << "!\n";
        return ERROR_IN_TOKENS_NUMBER;
    }

    Compiling::Lexer::TokenData expectedTokens [18];
    expectedTokens [0] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_EXTERN_COMMAND);
    expectedTokens [1] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_IDENTIFIER, "inbuilt_func");
    expectedTokens [2] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_OPERATOR, "(");
    expectedTokens [3] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_IDENTIFIER, "arg1");
    expectedTokens [4] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_OPERATOR, ",");
    expectedTokens [5] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_IDENTIFIER, "arg2");
    expectedTokens [6] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_OPERATOR, ")");
    expectedTokens [7] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_DEF_COMMAND);
    expectedTokens [8] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_IDENTIFIER, "func1");
    expectedTokens [9] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_OPERATOR, "(");
    expectedTokens [10] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_OPERATOR, ")");
    expectedTokens [11] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_IDENTIFIER, "a");
    expectedTokens [12] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_OPERATOR, "=");
    expectedTokens [13] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_NUMBER, "5.67");
    expectedTokens [14] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_IDENTIFIER, "func1");
    expectedTokens [15] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_OPERATOR, "(");
    expectedTokens [16] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_OPERATOR, ")");
    expectedTokens [17] = Compiling::Lexer::TokenData (Compiling::Lexer::TOKEN_END_OF_INPUT);
